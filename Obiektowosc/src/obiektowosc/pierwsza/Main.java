...
public class Main {
	...
	public static void main(String[] args) {
		...
		Samochod s2 = new Samochod("Audi", "A4", 12993921, "szary", 2003);
		Samochod s3 = new Samochod("Toyota", "Auris", 75000, "bialy", 2013);
		Samochod s4 = new Samochod("VW", "passat", 199999, "czarny", 1888);

		System.out.println(Samochod.getEkstensja());

		Samochod s5 = new Samochod("VW", "gol", 9999, "czarny", 2005);
		System.out.println(Samochod.getEkstensja());
