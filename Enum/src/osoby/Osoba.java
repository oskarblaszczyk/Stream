...
public class Osoba {
	...
	//* Napisz metod� kt�ra liczy ile jest os�b z kolorem wlosow podanym jako parametr
	...
	//* Napisz metod� kt�ra zwraca Osobe o najdluzszym nazwisku z oczami podanymi jako parametr
